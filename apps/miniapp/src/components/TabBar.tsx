...
const TABS = [
  // Ведёт на экран с четырьмя дверями — тот самый, с которого начинается
  // приложение. Значок-сетка из четырёх клеток и есть его изображение.
  { to: '/onboarding', icon: IconCatalog, label: 'Категории', end: true },
