 ...
 *
 * Живёт отдельно от страницы анкеты, потому что услуги человека видны
 * не только там: тот, кто и продаёт вещи, и работает мастером, — один
 * человек с одним профилем, и обратиться к нему можно из любого места,
 * где его услуги показаны.
 */
