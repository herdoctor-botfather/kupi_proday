...
/**
 * Сколько у мастера есть на ответ по заявке на услугу.
 *
 * Полчаса — не срок доставки, а срок реакции: услуга нужна сейчас, и
 * заказчик, не дождавшись, пойдёт к следующему. Долгое ожидание хуже
 * отказа, потому что отказ хотя бы освобождает.
 */
export const SERVICE_REQUEST_MINUTES = 30;

/** Максимальная длина пояснения к заявке. */
export const SERVICE_REQUEST_NOTE_MAX = 500;
