...
/**
 * Сколько фотографий помещается в объявление барахолки.
 * Форма размещения проверяет это ещё до отправки, чтобы человек не узнавал
 * о лимите после того, как выбрал два десятка снимков.
 */
