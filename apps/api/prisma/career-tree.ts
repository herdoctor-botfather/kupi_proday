...
export const CAREER_ATTRIBUTES: AttributeSpec[] = [
  ...
  // «Оплату до» убрали: поле цены в форме уже спрашивает «Оплата от»,
  // а вилку, если она есть, пишут в описании. Второе число рядом с первым
  // путало — его принимали за обязательное.
  {
    slug: 'schedule',
    name: 'График',
