...
const BANNERS = [
  {
    file: 'welcome',
    title: 'Мастера и объявления',
    subtitle: 'Всё внутри Telegram — без сайтов и звонков',
    rows: [
      ['🔧', 'Услуги', 'мастера с отзывами, ценами и картой'],
      ['🛍', 'Купи-продай', 'вещи от людей поблизости'],
      ['🔎', 'Люди ищут', 'кому-то нужно то, что у вас есть'],
      ['💬', 'Чат внутри', 'договариваетесь здесь же'],
    ],
  },
  {
    file: 'market',
