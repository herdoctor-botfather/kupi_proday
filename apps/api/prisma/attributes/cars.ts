...
const GENERATIONS: Record<string, string[]> = {
  Granta: ['2011–2018 · седан', '2018–наст. время · седан', '2018–наст. время · лифтбек', '2018–наст. время · универсал'],
  Vesta: ['2015–2022 · седан', '2015–2022 · SW Cross', '2022–наст. время · седан', '2022–наст. время · SW Cross'],
  Niva: ['1977–2021 · 3 двери', '2021–наст. время · Legend', '2020–наст. время · Travel'],
  Largus: ['2012–2021 · универсал', '2021–наст. время · универсал', 'фургон'],
  ...
  Camry: ['2006–2011 · XV40', '2011–2017 · XV50', '2017–наст. время · XV70'],
  ...
  Rio: ['2011–2017 · седан', '2017–2023 · седан', '2017–2023 · X-Line'],
  Sportage: ['2010–2015 · SL', '2015–2021 · QL', '2021–наст. время · NQ5'],
  Ceed: ['2012–2018 · второе поколение', '2018–наст. время · третье поколение'],
  Solaris: ['2010–2017 · первое поколение', '2017–2022 · второе поколение'],
  Creta: ['2016–2021 · первое поколение', '2021–наст. время · второе поколение'],
